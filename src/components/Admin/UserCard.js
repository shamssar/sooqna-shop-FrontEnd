...
export default function UserCard({user}) {
  ...
  return (
    <>
    {user.role==='user' ?
     <div className="center" style={{ margin: '13px 7rem 13px 5rem', display:'grid', gridTemplateColumns:'26rem 26rem', gridGap:'10rem' }}>
<div className="usercard"> 
      ...
      <svg width="110" height="110" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="title desc" className="center">
        ...
        <g stroke="none" stroke-width="0" clip-path="url(#scene)">
          ...
          <g id="shirt">
            ...
            <path stroke="#daa37f" stroke-width="1" className="skin hand" id="hand-left" d="M 51,270 C 46,263 60,243 63,246 65,247 66,248 61,255 72,243 76,238 79,240 82,243 72,254 69,257 72,254 82,241 86,244 89,247 75,261 73,263 77,258 84,251 86,253 89,256 70,287 59,278" /> 
            <path stroke="#daa37f" stroke-width="1" className="skin hand" id="hand-right" d="M 199,270 C 204,263 190,243 187,246 185,247 184,248 189,255 178,243 174,238 171,240 168,243 178,254 181,257 178,254 168,241 164,244 161,247 175,261 177,263 173,258 166,251 164,253 161,256 180,287 191,278"/> 
          </g>
        </g>
      </svg>
  ...
  <div className="general">
   ...
   <br/> 
    <button type="button" className="btn btn-primary" style={{ backgroundColor: "#003566" }} size="lg" variant="primary" onClick={() => {removeUserById(user.id,token)}}>Delete</button>
